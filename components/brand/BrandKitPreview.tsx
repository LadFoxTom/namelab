...
export function BrandKitPreview({
  ...
  return (
    <div className="mt-8 space-y-8">
      ...
      >
        <div className="py-8 sm:py-16 flex flex-col items-center justify-center px-4">
          {concept && (
            <img
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-white">{domainName}{tld}</h2>
          ...
          <div className="space-y-4">
            {typography.displayFont && (
              <div>
                ...
                <p className="text-xl sm:text-3xl font-bold text-[#1A1A18] mt-1">{domainName}</p>
      ...
      <div className="rounded-2xl border border-[#E6E6E4] bg-white p-4 sm:p-6">
        ...
        <div className="flex gap-4 overflow-x-auto pb-2">
          {MOCKUP_TYPES.map((m) => (
            <div
              key={m.type}
              className="flex-shrink-0 w-[200px] sm:w-[280px] cursor-pointer"
      ...
      <div className="rounded-2xl border border-[#E6E6E4] bg-white p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            className="sm:px-6 py-3 border border-[#E6E6E4] rounded-xl text-[#585854] hover:bg-[#FAFAF8] disabled:opacity-40 transition-colors text-sm"
          >
...
function ColorSwatch({ color, label }: { color: string; label: string }) {
  return (
    <div className="flex flex-col items-center gap-1">
      <div
        className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl border border-[#E6E6E4]"
